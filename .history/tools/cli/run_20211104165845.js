...
/// tools 版本
program
    .version(`@wisewe-form/tools v${require(pkgUrl).version}`, '-v, --version', 'tools versions')

program
    .command('build [flag]')
    .description('build packages')
    .option('-a,--all', 'Build @wisewe-form/[all]packages') /// 默认打包搓个
    .option('-p, --packages <ui-package...>', 'Build @wisewe-form/<ui-package> package or packages array') // 默认打单独的包支持数据
