 ...
 * @Description  : 头部注释
 * @FilePath     : /wisewe-form2/packages/element-ui/examples/App.vue
-->
<template>
	<div>
		...
		<ElRow>
			...
			<br />
			<ElRow>
				<ElButton @click="submitBtnProps"
					>设置提交按钮(submitBtnProps)</ElButton
				>
			...
			<ElRow>
				...
				<ElButton @click="clearValidateState"
					>清空验证(clearValidateState)</ElButton
				>
			</ElRow>
			<br />
			<ElRow>
			...
			<ElButton @click="createJson" style="color: #ff7271"
				>获取 json 字符串生成规则(toJson)</ElButton
			>
		</ElRow>
		<ElRow>
			<h3>Render</h3>
