...
export default function mock() {
    return [
...

        {
            ...
            field: 'txt',
            title: '富文本框',
            value: '<h1 style="color: #419bf7;">wisewe-form</h1><a href="https://github.com/xaboy/wisewe-form">GitHub</a>'
        },


        //upload 上传组件
        maker.upload('轮播图', 'pic', ['http://file.lotkk.com/wisewe-form.jpeg'])
            .props({
        ...
        //frame 框架组件
        maker.frame('素材', 'fodder', ['http://file.lotkk.com/wisewe-form.jpeg']).props({
            src: '/iframe.html',
            maxLength: 0,
            type: 'image',
            width: '80%',
