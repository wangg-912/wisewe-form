import deepExtend from '@wisewe-form/utils/lib/deepextend';
import is from '@wisewe-form/utils/lib/type';
import mergeProps from '@wisewe-form/utils/lib/mergeprops';
import { arrayAttrs, normalAttrs } from './attrs';
import { logError } from '@wisewe-form/utils/lib/console';
export { parseJson, parseFn, toJson } from '@wisewe-form/utils/lib/json';
