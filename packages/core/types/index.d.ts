...
> extends PluginObject<
		Options<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
	> {
...
export class BaseCreator<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> {
	...
	children(
		prop: FormRule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>[]
	): this;
...
export interface BaseApi<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> {
	...
	nextTick(
		fn: ($f: Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>) => void
	): void;
...
export interface Effect<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> {
	...
	init?: (
		data: { value: any; getValue: () => any; repeat: Boolean },
		rule: Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>,
		$f: Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
	) => void;
	load?: (
